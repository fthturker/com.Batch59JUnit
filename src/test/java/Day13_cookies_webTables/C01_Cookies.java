...
public class C01_Cookies extends TestBase {
    ...
    public void cookiesTesti() {
        ...
        System.out.println(cookiesSet); //set olarak yazdirdik
        int sayac=1;
        ...
        System.out.println(cookieSayisi); // kac tane cookies oldugunu yazdirdik 7 tane
        ...
        driver.manage().addCookie(cookie); //eklemek icin addCookie() kullandik
        sayac=1;
