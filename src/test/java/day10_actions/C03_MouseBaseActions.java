...
public class C03_MouseBaseActions extends TestBase {
    ...
    public void test01() {
        ...
        String ilkSayfaWindowHandleDegeri1="";
        for (String each:handleSeti
             ) {
            if (!each.equals(ilkSayfaWindowHandleDegeri)){
                ilkSayfaWindowHandleDegeri1=each;
            }
        }

        //7- Acilan sayfada h1 taginda “Elemental Selenium” yazdigini test edelim
        driver.switchTo().window(ilkSayfaWindowHandleDegeri1);
